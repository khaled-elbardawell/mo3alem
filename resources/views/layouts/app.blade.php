...
<body class="min-h-screen bg-[#f8f7fc] pt-[76px] font-['Tajawal',sans-serif] text-slate-900 max-[620px]:pt-16">
    <header class="site-header fixed inset-x-0 top-0 z-50 border-b border-[#e7e2f0] bg-white/[0.92] backdrop-blur-[16px]">
        <div
            ...
            <a class="inline-flex items-center gap-2.5 text-[30px] font-black max-[620px]:text-2xl" href="{{ route('home') }}" aria-label="نرد">
                <span>نرد</span>
                <span
            ...
            <nav class="flex items-center justify-self-center gap-[clamp(18px,4vw,58px)] font-bold text-[#1f2937] max-[900px]:hidden" aria-label="روابط الموقع">
                <a class="relative pt-7 pb-[23px] hover:text-[#6d28d9]" href="{{ route('home') }}#home">الرئيسية</a>
                <a class="relative pt-7 pb-[23px] hover:text-[#6d28d9]" href="{{ route('home') }}#how">كيف تعمل العجلة؟</a>
                <a class="relative pt-7 pb-[23px] hover:text-[#6d28d9]" href="{{ route('home') }}#faq">الأسئلة الشائعة</a>
            </nav>
        ...
        <div
            class="mx-auto mb-3 hidden w-[min(calc(100%_-_28px),1320px)] rounded-[18px] border border-[#e7e2f0] bg-white p-3 shadow-[0_18px_50px_rgba(76,29,149,0.08)] [&.is-open]:grid"
            id="mobileDrawer">
            <a class="rounded-xl px-3.5 py-[13px] font-extrabold text-[#344054] hover:bg-[#f4efff] hover:text-[#6d28d9]" href="{{ route('home') }}#home">الرئيسية</a>
            <a class="rounded-xl px-3.5 py-[13px] font-extrabold text-[#344054] hover:bg-[#f4efff] hover:text-[#6d28d9]" href="{{ route('home') }}#how">كيف تعمل العجلة؟</a>
            <a class="rounded-xl px-3.5 py-[13px] font-extrabold text-[#344054] hover:bg-[#f4efff] hover:text-[#6d28d9]" href="{{ route('home') }}#faq">الأسئلة الشائعة</a>
    ...
    <main class="mx-auto w-[min(calc(100%_-_2rem),1180px)] py-8">
        @if(session('status'))
            <div class="mb-6 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3 font-bold text-emerald-800" role="status">
                {{ session('status') }}
            </div>
        @endif
        @if($errors->any())
