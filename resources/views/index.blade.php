    ...
    <main>
        ...
        <section class="h-banner mx-auto w-[min(calc(100%_-_44px),1040px)] max-[620px]:w-[min(calc(100%_-_28px),1040px)]"
            ...
            <a class="ad-link ad-link--top mt-[18px] block overflow-hidden rounded-[18px] leading-none shadow-[0_18px_50px_rgba(76,29,149,0.08)] max-[900px]:mt-3 [&_img]:block [&_img]:h-full [&_img]:w-full [&_img]:object-cover"
                href="https://cmp-tch.com/" target="_blank" rel="noreferrer"
        ...
        <section
            class="app-shell mx-auto mt-7 grid w-[min(calc(100%_-_44px),1320px)] grid-cols-[250px_minmax(360px,1fr)_410px] items-start gap-[30px] max-[1180px]:grid-cols-[minmax(320px,1fr)_390px] max-[900px]:mt-[26px] max-[900px]:w-[min(calc(100%_-_28px),1320px)] max-[900px]:grid-cols-1 max-[900px]:gap-6 max-[620px]:mt-[22px] [&>*]:min-w-0"
            aria-label="تطبيق العجلة">
            <!-- إعلان جانبي: الصورة كلها رابط -->
            <aside
                class="side-ad-card rounded-[22px] max-[1180px]:col-span-full max-[900px]:order-3">
            ...
            <aside
                ...
                <div class="mode-tabs grid grid-cols-2 gap-2.5 [&_button]:inline-flex [&_button]:min-h-[46px] [&_button]:cursor-pointer [&_button]:items-center [&_button]:justify-center [&_button]:gap-2 [&_button]:rounded-[14px] [&_button]:border [&_button]:border-[#e7e2f0] [&_button]:bg-[#fafafa] [&_button]:font-black [&_button]:text-[#344054] [&_button.active]:border-[#d8c7ff] [&_button.active]:bg-white [&_button.active]:text-[#6d28d9] [&_button.active]:shadow-[inset_0_-3px_0_#6d28d9] max-[620px]:[&_button]:min-h-11 max-[620px]:[&_button]:text-sm"
                ...
                <div class="tab-page active hidden [&.active]:block" id="dataPage" role="tabpanel"
                    ...
                    <div
                        class="count-row list-controls mt-4 grid grid-cols-[28px_auto_minmax(0,1fr)] items-center gap-2.5 rounded-[14px] bg-[#fbfbfd] px-3.5 py-3 text-[#1f2937] max-[620px]:grid-cols-[28px_minmax(0,1fr)]">
        ...
        <section
            ...
            <div class="stats-grid mt-6 grid grid-cols-4 gap-[18px] max-[1180px]:grid-cols-2 max-[620px]:grid-cols-1">
                <article
                    ...
                    <strong class="text-[25px] font-black text-[#6d28d9]">128,640</strong>
                </article>
                <article
                    class="stat-card group grid min-h-28 grid-cols-[auto_1fr] items-center gap-x-4 rounded-[18px] border border-[#e7e2f0] bg-white/[0.92] p-[22px] shadow-[0_8px_30px_rgba(15,23,42,0.04)] max-[620px]:min-h-24">
                    <span
                    ...
                    <strong class="text-[25px] font-black text-[#6d28d9]">5,842</strong>
                </article>
                <article
                    class="stat-card group grid min-h-28 grid-cols-[auto_1fr] items-center gap-x-4 rounded-[18px] border border-[#e7e2f0] bg-white/[0.92] p-[22px] shadow-[0_8px_30px_rgba(15,23,42,0.04)] max-[620px]:min-h-24">
                    <span
                        class="stat-icon row-span-3 grid h-14 w-14 place-items-center rounded-full bg-[#fffbeb] text-[22px] font-black text-[#f59e0b] transition-transform duration-200 group-hover:scale-[1.08] group-hover:-rotate-4"><i
                            class="fa-regular fa-clock"></i></span>
                    <small class="font-extrabold text-[#344054]">ساعات الاستخدام</small>
                    <strong class="text-[25px] font-black text-[#6d28d9]">12,870</strong>
                </article>
                <article
                    class="stat-card group grid min-h-28 grid-cols-[auto_1fr] items-center gap-x-4 rounded-[18px] border border-[#e7e2f0] bg-white/[0.92] p-[22px] shadow-[0_8px_30px_rgba(15,23,42,0.04)] max-[620px]:min-h-24">
                    <span
                    ...
                    <strong class="text-[25px] font-black text-[#6d28d9]">+2,000,000</strong>
                    <em class="text-[13px] font-bold text-[#667085] not-italic">أكثر من مليوني اسم</em>
                </article>
            </div>
        </section>
        ...
        <section
            ...
            <div class="save-mode__content min-w-0">
                ...
                <div
                    ...
                    <button
                        class="btn btn--primary inline-flex min-h-11 cursor-pointer items-center justify-center gap-[9px] rounded-xl border-0 bg-linear-to-br from-[#7c3aed] to-[#5b21b6] px-5 py-2 text-center font-extrabold whitespace-normal text-white shadow-[0_12px_28px_rgba(51,65,85,0.24)] transition-[transform,box-shadow,border-color,background] duration-200 hover:-translate-y-px disabled:cursor-not-allowed disabled:opacity-[0.58] disabled:shadow-none disabled:hover:translate-y-0"
                        type="button">
