...
@section('content')
    ...
    <section class="scroll-mt-24 border-b border-slate-100 bg-white py-16 sm:py-20" id="activity" data-section-surface="plain">
        <div class="relative mx-auto w-[min(calc(100%_-_2rem),1280px)]">
            ...
            <div class="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-4" data-reveal-group>
                @foreach([
                    ['key' => 'qr', 'value' => $platformActivity['qrCodes'], 'label' => 'رموز QR تم إنشاؤها', 'icon' => 'fa-qrcode', 'iconStyle' => 'from-white via-indigo-50/70 to-slate-100 text-indigo-600/80 shadow-[0_10px_24px_rgba(15,23,42,0.08)]', 'sparkle' => 'text-indigo-300/70', 'dots' => 'text-indigo-200', 'accent' => 'bg-indigo-400'],
                    ['key' => 'certificates', 'value' => $platformActivity['certificates'], 'label' => 'شهادات تم تصميمها', 'icon' => 'fa-award', 'iconStyle' => 'from-white via-amber-50/70 to-slate-100 text-amber-600/80 shadow-[0_10px_24px_rgba(15,23,42,0.08)]', 'sparkle' => 'text-amber-300/70', 'dots' => 'text-amber-200', 'accent' => 'bg-amber-400'],
                    ['key' => 'competitions', 'value' => $platformActivity['competitions'], 'label' => 'مسابقات', 'icon' => 'fa-trophy', 'iconStyle' => 'from-white via-rose-50/70 to-slate-100 text-rose-600/80 shadow-[0_10px_24px_rgba(15,23,42,0.08)]', 'sparkle' => 'text-rose-300/70', 'dots' => 'text-rose-200', 'accent' => 'bg-rose-400'],
                    ['key' => 'users', 'value' => $platformActivity['activeUsers'], 'label' => 'مستخدمون نشطون', 'icon' => 'fa-users', 'iconStyle' => 'from-white via-violet-50/70 to-slate-100 text-violet-600/80 shadow-[0_10px_24px_rgba(15,23,42,0.08)]', 'sparkle' => 'text-violet-300/70', 'dots' => 'text-violet-200', 'accent' => 'bg-violet-500'],
                ] as $stat)
