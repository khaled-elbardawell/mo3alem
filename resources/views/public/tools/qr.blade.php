...
@section('content')
    <div
        ...
        <x-public.tool-page-header title="أداة إنشاء رمز QR"
            description="حوّل الروابط والنصوص وبيانات الشبكة إلى رمز QR مخصّص وجاهز للتنزيل والمشاركة." current="إنشاء رمز QR"
            icon="fa-qrcode" />
                ...
                <div class="grid min-w-0 grid-cols-1 gap-3 lg:grid-cols-[320px_minmax(0,1fr)_68px] lg:rounded-3xl lg:border lg:border-slate-200 lg:bg-[#f7f7fb] lg:p-3 lg:shadow-[0_18px_60px_rgba(15,23,42,0.08)]"
                    ...
                    <section
                        ...
                        <div class="flex items-center justify-between gap-3">
                            ...
                            <span
                                class="grid h-11 w-11 place-items-center rounded-2xl bg-violet-100 text-xl text-violet-700"><i
                        ...
                        <form class="mt-5 grid gap-5" id="qrForm" novalidate>
                            <fieldset class="grid gap-3" data-qr-sidebar-panel="content">
                                ...
                                <div class="grid gap-3">
                                    <div class="flex items-center justify-between gap-3">
                                        ...
                                        <span
                                            class="hidden rounded-full bg-slate-100 px-2.5 py-1 text-[11px] font-black text-slate-600"
                                    ...
                                    <div class="grid grid-cols-2 gap-2" role="radiogroup" aria-label="طريقة عمل رمز QR">
                                        <label class="group relative cursor-pointer">
                                            <input class="peer sr-only" type="radio" name="mode" value="static"
                                                checked>
                                            <span
                                                class="flex flex-col justify-center gap-1 rounded-2xl border border-slate-200 bg-white p-3 text-slate-600 transition peer-checked:border-violet-500 peer-checked:bg-violet-50 peer-checked:text-violet-800 peer-focus-visible:ring-4 peer-focus-visible:ring-violet-100 peer-disabled:cursor-not-allowed">
                                                <span class="inline-flex items-center gap-2 text-sm font-black"><i
                                                        class="fa-solid fa-qrcode" aria-hidden="true"></i> ثابت</span>
                                            </span>
                                        </label>
                                        <label class="group relative cursor-pointer">
                                            <input class="peer sr-only" type="radio" name="mode" value="dynamic">
                                            <span
                                                class="flex flex-col justify-center gap-1 rounded-2xl border border-slate-200 bg-white p-3 text-slate-600 transition peer-checked:border-emerald-500 peer-checked:bg-emerald-50 peer-checked:text-emerald-800 peer-focus-visible:ring-4 peer-focus-visible:ring-emerald-100 peer-disabled:cursor-not-allowed">
                                                <span class="flex flex-wrap items-center gap-1.5 text-sm font-black"><span
                                                        class="inline-flex items-center gap-2"><i
                                                            class="fa-solid fa-arrows-rotate" aria-hidden="true"></i>
                                                        ديناميكي</span></span>
                                            </span>
                                        </label>
                                    </div>
                                ...
                                <div class="grid grid-cols-3 gap-2" id="qrContentTypeGrid" role="radiogroup"
                                    aria-label="نوع محتوى الرمز">
                                    @foreach ([['value' => 'url', 'label' => 'رابط', 'icon' => 'fa-link'], ['value' => 'text', 'label' => 'نص', 'icon' => 'fa-align-right'], ['value' => 'wifi', 'label' => 'Wi-Fi', 'icon' => 'fa-wifi']] as $type)
                                        <label class="group relative"
                                            @if ($type['value'] !== 'url') data-static-content-type @endif>
                                ...
                                <div class="hidden gap-3 rounded-2xl border border-emerald-200 bg-emerald-50 p-4"
                                    ...
                                    <div class="flex items-start gap-3">
                                        <span
                                            class="grid size-9 shrink-0 place-items-center rounded-xl bg-white text-emerald-700 shadow-sm"><i
                                                class="fa-solid fa-link" aria-hidden="true"></i></span>
                                        <div>
                                            <h3 class="text-sm font-black text-emerald-950">رابط ثابت، وجهة قابلة للتعديل
                                            </h3>
                                            <p class="mt-1 text-xs font-bold leading-5 text-emerald-800">يجب حفظ الرمز في
                                                حسابك قبل تنزيله. بعد ذلك يمكنك تغيير الوجهة دون إعادة الطباعة.</p>
                                        </div>
                                    </div>
                                    @guest
                                        <div class="grid gap-3 rounded-xl border border-emerald-200 bg-white p-3 shadow-sm"
                                            ...
                                            <div class="flex items-start gap-2.5">
                                                <span
                                                    class="grid size-9 shrink-0 place-items-center rounded-xl bg-emerald-100 text-emerald-700"><i
                                                        class="fa-solid fa-lock" aria-hidden="true"></i></span>
                                                <div>
                                                    <h4 class="text-sm font-black text-slate-900">سجّل الدخول لتفعيل الرابط
                                                        الديناميكي</h4>
                                                    <p class="mt-1 text-xs font-bold leading-5 text-slate-600">سنحفظ الرابط
                                                        والتصميم، وبعدها يمكنك تغيير الوجهة ومتابعة عدد المسحات.</p>
                                                </div>
                                            </div>
                                            <div class="grid gap-2 sm:grid-cols-2 lg:grid-cols-1">
                                                <a class="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl bg-emerald-700 px-3 text-sm font-black text-white hover:bg-emerald-800"
                                                    href="{{ route('tools.qr.auth', 'register') }}" data-qr-register-link><i
                                                        class="fa-solid fa-user-plus" aria-hidden="true"></i> إنشاء حساب
                                                    مجاني</a>
                                                <a class="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl border border-emerald-200 px-3 text-sm font-black text-emerald-800 hover:bg-emerald-50"
                                                    href="{{ route('tools.qr.auth', 'login') }}" data-qr-login-link>لدي حساب —
                                                    تسجيل الدخول</a>
                                            </div>
                                        </div>
                                    @else
                                        @unless (auth()->user()->hasVerifiedEmail())
                                            <div class="grid gap-3 rounded-xl border border-amber-200 bg-amber-50 p-3"
                                                ...
                                                <p class="text-xs font-black leading-5 text-amber-900"><i
                                                        class="fa-solid fa-envelope-circle-check ml-1" aria-hidden="true"></i>
                                                    فعّل بريدك لتتمكن من حفظ الرابط الديناميكي وتفعيله.</p>
                                    ...
                                    <div class="hidden gap-2" id="qrDynamicSavedPanel">
                                        <label class="text-xs font-black text-emerald-950" for="qrPublicUrl">رابط الرمز
                                            الديناميكي</label>
                                        <div class="flex gap-2">
                                            <input
                                                class="min-w-0 flex-1 rounded-xl border border-emerald-200 bg-white px-3 py-2 text-left text-xs font-bold text-slate-600"
                                                id="qrPublicUrl" type="url" dir="ltr" readonly>
                                            <button
                                                class="grid size-10 shrink-0 place-items-center rounded-xl bg-emerald-700 text-white hover:bg-emerald-800"
                                                id="copyQrPublicUrl" type="button" aria-label="نسخ الرابط الديناميكي"><i
                                                    class="fa-regular fa-copy" aria-hidden="true"></i></button>
                                        </div>
                                    </div>
                                    <label
                                        class="flex items-center justify-between gap-3 rounded-xl bg-white p-3 text-sm font-black text-slate-700">
                                    ...
                                    <label class="grid gap-2 text-xs font-black text-slate-700" for="qrExpiresAt">
                                        ...
                                        <input
                                            class="min-h-11 rounded-xl border border-emerald-200 bg-white px-3 text-left outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100"
                                ...
                                <div class="grid gap-3 border-t border-slate-100 pt-5">
                                    ...
                                    <div class="grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
                                        @foreach ([['id' => 'qrForegroundColor', 'label' => 'لون الرمز', 'value' => '#111827'], ['id' => 'qrEyeColor', 'label' => 'لون الزوايا', 'value' => '#6d28d9'], ['id' => 'qrBackgroundColor', 'label' => 'الخلفية', 'value' => '#ffffff']] as $color)
                                            <label class="grid gap-2 text-xs font-black text-slate-600"
                                                for="{{ $color['id'] }}">
                                                {{ $color['label'] }}
                                                <span
                            ...
                            <fieldset class="hidden min-w-0 gap-3 overflow-hidden" data-qr-sidebar-panel="frames">
                                ...
                                <p class="text-xs font-bold leading-5 text-slate-500">اختر إطارًا جاهزًا أو اترك الرمز دون
                                    قالب.</p>
                                <div class="flex w-full max-w-full min-w-0 snap-x snap-mandatory gap-2 overflow-x-auto overscroll-x-contain pb-2 [scrollbar-width:thin] lg:grid lg:max-h-[560px] lg:grid-cols-2 lg:overflow-y-auto lg:pl-1"
                                    role="radiogroup" dir="ltr" aria-label="قالب الإطار">
                                    <label class="cursor-pointer" dir="rtl">
                                        <input class="peer sr-only" type="radio" name="qr_frame" value="none"
                                            checked>
                                        <span
                    ...
                    <section class="order-1 min-w-0 lg:order-none lg:col-start-2 lg:row-start-1"
                        aria-labelledby="qrPreviewTitle">
                        <div class="rounded-2xl border border-slate-200 bg-white p-3 sm:p-4 lg:sticky lg:top-24">
                            <div class="flex items-center justify-between gap-3">
                                <div>
                                ...
                                <span
                                    ...
                                    id="qrPreviewWaitingBadge"><i class="fa-regular fa-clock"
                                        aria-hidden="true"></i><span id="qrPreviewWaitingLabel">بانتظار
                                        المحتوى</span></span>
                                <span
                                    class="hidden items-center gap-2 rounded-full bg-emerald-50 px-3 py-1.5 text-xs font-black text-emerald-700"
                                    id="qrPreviewReadyBadge"><i class="fa-solid fa-circle text-[7px]"
                                        aria-hidden="true"></i>
                                    جاهز للمسح</span>
                            </div>
                            ...
                            <div class="mt-3 grid min-h-[300px] place-items-center overflow-hidden rounded-2xl border border-violet-100 bg-[radial-gradient(circle_at_50%_45%,rgba(124,58,237,0.1),transparent_42%),#f8f7ff] p-4 sm:min-h-[500px] sm:p-8 lg:min-h-[610px]"
                                ...
                                <div class="grid w-full max-w-[470px] place-items-center">
                                    ...
                                    <div class="hidden w-full max-w-sm place-items-center gap-4 rounded-3xl border border-emerald-200 bg-white/90 p-6 text-center shadow-xl shadow-emerald-900/5"
                                        ...
                                        <span
                                            class="grid size-20 place-items-center rounded-3xl bg-emerald-100 text-3xl text-emerald-700"><i
                                                class="fa-solid fa-lock" aria-hidden="true"></i></span>
                                        @guest
                                            <div class="grid gap-2">
                                                <h3 class="text-xl font-black text-slate-900">فعّل QR الديناميكي بحساب مجاني
                                                </h3>
                                                <p class="text-sm font-bold leading-6 text-slate-600">سجّل الدخول لحفظ الرابط،
                                                    تغييره لاحقًا، ومتابعة المسحات.</p>
                                            </div>
                                            <div class="grid w-full gap-2 sm:grid-cols-2">
                                                <a class="inline-flex min-h-11 items-center justify-center rounded-xl bg-emerald-700 px-3 text-sm font-black text-white hover:bg-emerald-800"
                                                    href="{{ route('tools.qr.auth', 'register') }}"
                                                    data-qr-register-link>إنشاء حساب مجاني</a>
                                                <a class="inline-flex min-h-11 items-center justify-center rounded-xl border border-emerald-200 px-3 text-sm font-black text-emerald-800 hover:bg-emerald-50"
                                                    href="{{ route('tools.qr.auth', 'login') }}" data-qr-login-link>تسجيل
                                                    الدخول</a>
                                            </div>
                                        @else
                                            @if (auth()->user()->hasVerifiedEmail())
                                                <div class="grid gap-2">
                                                    ...
                                                    <p class="text-sm font-bold leading-6 text-slate-600">بعد الحفظ ستظهر
                                                        المعاينة الفعلية ويمكنك تنزيلها مباشرة.</p>
                                                </div>
                                                <button
                                                    class="inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-xl bg-emerald-700 px-4 text-sm font-black text-white hover:bg-emerald-800"
                                                    type="button" data-open-dynamic-save><i class="fa-regular fa-floppy-disk"
                                                        aria-hidden="true"></i> حفظ وتفعيل الرمز</button>
                                            @else
                                                <div class="grid gap-2">
                                                    <h3 class="text-xl font-black text-slate-900">فعّل بريدك للمتابعة</h3>
                                                    <p class="text-sm font-bold leading-6 text-slate-600">يجب تفعيل البريد قبل
                                                        حفظ الرابط الديناميكي.</p>
                                                </div>
                            ...
                            @guest
                                <div class="mt-3 hidden rounded-2xl border border-violet-200 bg-violet-50 p-4 lg:block"
                                    id="guestCloudSaveCard">
                                    <div class="flex items-start gap-3">
                                        <span
                                        ...
                                        <div>
                                            ...
                                            <p class="mt-1 text-sm font-bold leading-6 text-slate-600">أنشئ حسابًا مجانيًا
                                                لتحفظ
                                ...
                                @else
                                    <div
                                        ...
                                        <span class="inline-flex items-center gap-2"><i
                                                class="fa-solid fa-envelope-circle-check" aria-hidden="true"></i> فعّل بريدك
                                            لتبدأ الحفظ السحابي</span>
                    ...
                    <nav class="fixed inset-x-2 bottom-2 z-90 grid grid-cols-5 gap-1 rounded-2xl border border-slate-200 bg-white/95 p-2 shadow-[0_12px_35px_rgba(15,23,42,0.15)] backdrop-blur-xl lg:order-none lg:sticky lg:inset-auto lg:top-24 lg:col-start-3 lg:row-start-1 lg:z-auto lg:flex lg:flex-col lg:gap-2 lg:border-0 lg:bg-slate-950 lg:p-2 lg:text-white lg:shadow-none"
                        ...
                        @foreach ([['content', 'fa-link', 'المحتوى'], ['appearance', 'fa-palette', 'المظهر'], ['center', 'fa-image', 'الوسط'], ['frames', 'fa-border-all', 'الإطار']] as [$panel, $icon, $label])
                            <button
                                ...
                                type="button" data-qr-sidebar-tab="{{ $panel }}"
                                @if ($panel === 'content') data-selected aria-selected="true" @else aria-selected="false" @endif>
        ...
        <dialog
            ...
            <div class="p-5 sm:p-6">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        <span
                            class="inline-flex items-center gap-2 rounded-full bg-emerald-50 px-3 py-1 text-xs font-black text-emerald-700"><i
                                class="fa-solid fa-circle-check" aria-hidden="true"></i> جاهز للاستخدام</span>
                        <h2 class="mt-3 text-2xl font-black text-[#111a35]" id="qrExportDialogTitle">تنزيل ومشاركة الرمز
                        </h2>
                        <p class="mt-1 text-sm font-bold leading-6 text-slate-500">اختر الصيغة المناسبة، أو انسخ الصورة
                            مباشرة.</p>
                    </div>
                    <button
                ...
                <div class="mt-5 hidden grid-cols-2 gap-2 sm:grid-cols-3" id="qrDownloadActions">
                    ...
                    <button
                        ...
                        id="downloadQrSvg" type="button"><i class="fa-solid fa-bezier-curve" aria-hidden="true"></i>
                        تنزيل SVG</button>
                    <button
            ...
            <div class="w-[min(480px,calc(100vw_-_32px))] p-5 sm:p-6">
                ...
                <div class="mt-6 grid gap-2">
                    <a class="min-h-12 rounded-xl bg-violet-700 px-4 py-3 text-center font-black text-white hover:bg-violet-800"
                        id="qrRegisterLink" href="{{ route('tools.qr.auth', 'register') }}" data-qr-register-link>إنشاء
                        حساب مجاني</a>
                    <a class="min-h-12 rounded-xl border border-violet-200 px-4 py-3 text-center font-black text-violet-800 hover:bg-violet-50"
                        id="qrLoginLink" href="{{ route('tools.qr.auth', 'login') }}" data-qr-login-link>لدي حساب — تسجيل
                        الدخول</a>
