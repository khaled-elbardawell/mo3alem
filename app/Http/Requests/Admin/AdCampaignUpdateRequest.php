...
class AdCampaignUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'image' => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp,gif', 'mimetypes:image/jpeg,image/png,image/webp,image/gif', 'max:5120'],
